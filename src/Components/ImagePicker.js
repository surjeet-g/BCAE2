...
/**
* Imagepicker provide manage upload image/file 
* @method
* @param  {boolean} attachmentModalVisible status of model disable or enable
* @param  {function} setAttachmentModalVisible handles model state value 
* @param  {Object} fileAttachments files data of uploaded
