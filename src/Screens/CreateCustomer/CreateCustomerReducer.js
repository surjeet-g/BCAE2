...
const initialState = {
  ...
  formData: {
    ...
    customerUuid: "73af1a82-6d34-4cb7-bbe1-144601f8ef2e",
    customerNo: "CUST00000482",
    customerId: "456",
    customerDetails: {
      categoryType: {
        code: "REG",
        description: "Regular",
        codeType: "CUSTOMER_CATEGORY",
        mapping: {
      ...
      firstName: "zzz",
      lastName: "zzz",
      birthDate: "2008-04-18T02:36:00.000Z",
      gender: {
        code: "M",
        description: "Male",
        codeType: "GENDER",
      ...
      idType: {
        ...
        codeType: "CUSTOMER_ID_TYPE",
        mapping: {},
        status: "AC",
      },
      idValue: "3453254",
      idPlace: "Ahm",
      emailId: "zzz@yopmail.com",
      contactType: {
        code: "CNTBUS",
