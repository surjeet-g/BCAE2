...
const CreateCustomer = ({ navigation }) => {
  ...
  */
  const onPlaceChosenEvnt = (params) => {
  ...
  const locationIconClick = () => {
    navigation.navigate("SavedLocation", {
      onPlaceChosen_2: onPlaceChosenEvnt,
...
*/
  ...
  /**
* calculate total billAmount from all selected product
* @memberOf CustomerOnBoarding
* @returns  {float} Return total sum of amount 
*/
  ...
  /**
* store and update customer form data 
* @memberOf CustomerOnBoarding
 * @param  {string} key index value of form data
 * @param  {string} value value value of form data
*/
  ...
  /**
* store and update customer account form data 
* @memberOf CustomerOnBoarding
 * @param  {string} key index value of form data
 * @param  {string} value value value of form data
*/
  ...
  /**
* store and update customer service form data 
* @memberOf CustomerOnBoarding
 * @param  {string} key index value of form data
 * @param  {string} value value value of form data
*/
  ...
  /**
  * Handle navigation to previouse step
  * @memberOf CustomerOnBoarding
  */
