...
import {
  Dimensions, Image, Pressable, StyleSheet, Text, TouchableHighlight, TouchableOpacity, View
} from "react-native";
                    ...
                    >
                      <View style={{
                        ...
                        <View style={{ flexDirection: "column", flex: 0.65 }}>
                          ...
                          <Text style={{ color: "#D72C0D", fontWeight: "500" }}>{item?.title}</Text>
                          <ClearSpace />
                          <Text>{item?.reason}</Text>
                        </View>

                        <View style={{ flexDirection: "column", flex: 0.25 }}>
                          <Text style={{ fontSize: 12 }}> {moment(item?.createdAt).fromNow()}</Text>
                        </View>
