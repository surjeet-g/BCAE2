...
/**
* Reducer Dispatch
* Handle API call for verify login 
* @memberOf Login
* @param  {Object} params payload for login API
...
/**
* Reducer Dispatch
* Handle already logged with other device
* Handle logout from other device and re-loggin again
* @memberOf Login
* @param  {Number} userId current user/customer ID
* @param  {Object} params payload for login API
* @param  {Object} navigation handle section timeout
* @returns {Object} Dispatcher to reducer
*/
